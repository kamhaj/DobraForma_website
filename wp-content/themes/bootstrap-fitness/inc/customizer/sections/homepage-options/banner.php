 ...
 */
add_action( 'customize_register', 'bootstrap_fitness_customize_banner_section' );

function bootstrap_fitness_customize_banner_section( $wp_customize ) {

    $wp_customize->get_section( 'header_image' )->panel = "bootstrap_fitness_homepage_panel";
    $wp_customize->get_section( 'header_image' )->title = esc_html__( "Banner Section", 'bootstrap-fitness' );
    ...
    $wp_customize->add_control( new Bootstrap_Fitness_Toggle_Control( $wp_customize, 'banner_section_display_option', array(
    ...
    $wp_customize->add_control( 'banner_section_title', array(
        'label' => esc_html__( 'Banner Main Title','bootstrap-fitness' ),
        'section' => 'header_image',
        'type'=> 'text',
        'priority'  =>  3
    ) );
    ...
    $wp_customize->selective_refresh->add_partial( 'banner_section_title', array(
        ...
        'render_callback' => 'bootstrap_fitness_get_banner_sec_title',
	) );
    ...
    $wp_customize->add_control( 'banner_section_description', array(
        'label' => esc_html__( 'Description','bootstrap-fitness' ),
        'section' => 'header_image',
    ...
    $wp_customize->selective_refresh->add_partial( 'banner_section_description', array(
        ...
        'render_callback' => 'bootstrap_fitness_get_banner_desc'
	) );
    ...
    $wp_customize->add_control( 'banner_section_cta_label', array(
        'label' => esc_html__( 'CTA Label','bootstrap-fitness' ),
        'section' => 'header_image',
    ...
    $wp_customize->selective_refresh->add_partial( 'banner_section_cta_label', array(
        ...
        'render_callback' => 'bootstrap_fitness_get_banner_cta'
	) );
    ...
    $wp_customize->add_control( 'banner_section_cta_link', array(
        'label' => esc_html__( 'CTA Link','bootstrap-fitness' ),
        'section' => 'header_image',
