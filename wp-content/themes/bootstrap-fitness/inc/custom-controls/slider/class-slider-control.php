...
if ( ! class_exists( 'Bootstrap_Fitness_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Bootstrap_Fitness_Slider_Control extends Wp_Customize_Control {

		public $type = 'bootstrap-fitness-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'bootstrap-fitness-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'bootstrap-fitness-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
