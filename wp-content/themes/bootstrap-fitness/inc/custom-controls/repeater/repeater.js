...
var RepeaterRow = function( rowIndex, container, label ) {
	...
	this.updateLabel = function() {
		...
		this.header.find( '.repeater-row-label' ).text( this.label.value );
	};
...
wp.customize.controlConstructor.repeater = wp.customize.Control.extend({
	ready: function() {
		...
		// The current value set in Control Class (set in Bootstrap_Fitness_Customize_Repeater_Control::to_json() function)
		...
		this.container.ready( function( e ) {
			
			if ( control.currentIndex < 1 ) {
				theNewRow = control.addRow();
				theNewRow.toggleMinimize();
				control.initColorPicker();
				if( typeof control.initDropdownPages !== "undefined" ) {
	...
	setImageInRepeaterField: function( attachment ) {
		...
		$targetDiv.find( '.bootstrap-fitness-image-attachment' ).html( '<img src="' + attachment.url + '">' ).hide().slideDown( 'slow' );
	...
	setFileInRepeaterField: function( attachment ) {
		...
		$targetDiv.find( '.bootstrap-fitness-file-attachment' ).html( '<span class="file"><span class="dashicons dashicons-media-default"></span> ' + attachment.filename + '</span>' ).hide().slideDown( 'slow' );
	...
	removeImage: function( event ) {
		...
		$targetDiv.find( '.bootstrap-fitness-image-attachment' ).slideUp( 'fast', function() {
	...
	removeFile: function( event ) {
		...
		$targetDiv.find( '.bootstrap-fitness-file-attachment' ).slideUp( 'fast', function() {
			jQuery( this ).show().html( jQuery( this ).data( 'placeholder' ) );
		});
		$targetDiv.find( '.hidden-field' ).val( '' );
		$uploadButton.text( $uploadButton.data( 'label' ) );
	...
	addRow: function( data ) {
		...
		var control       = this,
		    template      = control.repeaterTemplate(), // The template for the new row (defined on Bootstrap_Fitness_Customize_Repeater_Control::render_content() ).
