...
function fitness_insight_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new Fitness_Insight_Toggle_Control( $wp_customize, 'fitness_insight_slider_arrows', array(
		'label'       => esc_html__( 'Check to show slider', 'fitness-insight' ),
		'section'     => 'fitness_insight_slider_section',
		'type'        => 'toggle',
		'settings'    => 'fitness_insight_slider_arrows',
	) ) );
