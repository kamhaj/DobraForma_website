...
function fitness_insight_custom_styles($custom) {
	...
	wp_add_inline_style( 'fitness-insight-style', $custom );
}
add_action( 'wp_enqueue_scripts', 'fitness_insight_custom_styles' );

//Sanitizes Fonts
function fitness_insight_sanitize_fonts( $input ) {
	$valid = array(
		'' => 'Select',
